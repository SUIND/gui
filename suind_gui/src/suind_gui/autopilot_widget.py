...
class AutopilotWidget(QWidget):
    ...
    def connect(self, quad_namespace):
        ...
        self._go_to_pose_pub = rospy.Publisher(
            ...
            queue_size=1)
        self._vislam_reset_pub = rospy.Publisher(
            quad_namespace+'/vislam/reset', std_msgs.Empty,
            queue_size=1)
        self._enable_stereo_pub = rospy.Publisher(
            quad_namespace+'/enable_stereo_node', std_msgs.Bool,
            queue_size=1)
        ...
        self.button_vislam_reset.setEnabled(True)
        self.button_enable_stereo.setEnabled(True)
        self.button_disable_stereo.setEnabled(True)
    ...
    def disconnect(self):
        ...
        self.disconnect_pub_sub(self._vislam_reset_pub)
        self.disconnect_pub_sub(self._enable_stereo_pub)
        ...
        self.button_vislam_reset.setEnabled(False)
        self.button_enable_stereo.setEnabled(False)
        self.button_disable_stereo.setEnabled(False)
    ...
    def on_button_go_to_pose_clicked(self):
        try:
            ...
            go_to_pose_msg.header.frame_id = "world"
    ...
    def get_autopilot_state_name(self, autopilot_state):
        ...
        if (autopilot_state == self._autopilot_feedback.BREAKING):
            return "BREAKING"
        if (autopilot_state == self._autopilot_feedback.FINE_BREAKING):
            return "FINE BREAKING"
